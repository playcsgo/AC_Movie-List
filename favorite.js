...
// general var
const movies = JSON.parse(localStorage.getItem('favoraites')) || []
let filteredMovies = []
    ...
    data.forEach(item => {
      ...
      <div class="card">
        ...
        <div class="footer">
          ...
          <button href="#" class="btn btn-danger btn-remove-Favorite" data-id="${item.id}">X</button>
        </div>
      </div>
    </div>
      `
...
function getMovieByPage(page) {
  ...
  function removeFromFavorite(id) {
    ...
    localStorage.setItem('favoraites', JSON.stringify(movies))
    rednerMovieList(movies)
  }
